      ...
      <div class="shop_top">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-3">
              <div class="box-info-product"><p class="price2"></p>
          ...
          <div class="desc">
            <h2>Order Summary</h2>
            <h3> Thank you for your PayPal purchase! We used your PayPal email and address on file. </h3>
            <h4>
             Product Cost: $${order_cost} <br>
             Tax: $${order_tax} <br>
             Quantity: 1 <br> <br>
             Order Total: $${order_total} <br> <br>
