        ...
        <div class="container">
          <div class="col-md-6">
            <div class="login-page">
              ...
              <p>
                Welcome to an experience you'll never forget. Our products are
                top of the line, unbeatable.<br />
                WARNING: Our site is irresistable; you may go broke. We are not
                liable if this situation were to occur. By registering to this
                site, you acknowledge this risk. <br />
                ...
                >
                  <fieldset class="input">
                    <p id="login-form-username">
                      <label for="modlgn_username">Email (PayPal Method of Payment)</label>
                      <input
                        id="modlgn_username"
                        type="text"
                        name="email"
                    ...
                    <div class="remember">
                      <p id="login-form-remember">
                        <label for="modlgn_remember"
                          ><a href="#">Forget Your Password ? </a></label
                        >
                      </p>
                      <input
                        type="submit"
